...
// Constantes FILL
const userForm = document.querySelector('.fill'); 
...
const printURL = document.querySelector('.print__url--twitter');
const twitterCardButton = document.querySelector('.btn-twit');
